# Author : GH05T666
# fb : Arjun Gans
# github : www.github.com/ghost-exploiter
...
\033[96m
        ...
        ---------------------------------------------------------------
''')
print(" \033[95m Gunakan Perintah http://www.contoh.com/. atau https://www.contoh.com/ ")
print(" \033[95m Dan Berikan Tanda / Di Belakangnya EX: www.example.com/")
print("                                                                       ")
...
passe = ('admin/','administrator/','editor/','mini.php','shell.php','lol.php','404.php','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for hani in passe :
    ...
    try :
        ...
        print("                                                             ")
        print("\033[92m == Admin Login Ditemukan === "+curl)
        print("_____________________________________________________________")
    except urllib.error.URLError as msg :
        print ("\033[91m *** Maaf Kami Tidak Menemukan Apa-Apa === "+curl)


print ("----------------------------------------------------------------------------------------")
print ("\033[93m     Oke gans terimah kasih telah berkunjung jangan lupa bahagia ^_^" )
print ("----------------------------------------------------------------------------------------")
# Author : GH05T666
# fb : Arjun Gans
# github : www.github.com/ghost-exploiter
